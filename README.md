...
package "VolunteerSync Database" {
  
  TABLE_ENTITY Volunteer {
    + volunteerId: Long <<PK>>
    --
  ...
  TABLE_ENTITY NGO {
    ...
    + adminId: Long <<FK, unique>>
  }
  
  TABLE_ENTITY Opportunity {
    + opportunityId: Long <<PK>>
    --
  ...
  TABLE_ENTITY Application {
    + applicationId: Long <<PK>>
    --
    + volunteerId: Long <<FK>>
    + opportunityId: Long <<FK>>
    status: ApplicationStatus <<not null>>
    appliedDate: LocalDateTime <<not null>>
  }
  
  TABLE_ENTITY Location {
    + locationId: Long <<PK>>
    --
    name: String <<not null>>
...
' Relationships
Volunteer }|--|| Location : "belongs to"
NGO }|--|| Volunteer : "managed by"
Opportunity }|--|| NGO : "posted by"
Opportunity }|--|| Location : "located at"
Application }|--|| Volunteer : "submitted by"
Application }|--|| Opportunity : "for"
Location }|--o{ Location : "parent of"

' Unique Constraints
Volunteer ..|{ email : "unique"
NGO ..|{ contactEmail : "unique"
Location ..|{ code : "unique"
Application ..|{ (volunteerId, opportunityId) : "unique"

note top of Opportunity
  Constraints:
  maxVolunteers > 0
  eventDate in future
end note
...
note top of Location
  Constraints:
  parentId null for Province
  non-null for others
end note

note top of Volunteer
  Constraints:
  Valid Rwandan phone format
  (if provided)
end note
